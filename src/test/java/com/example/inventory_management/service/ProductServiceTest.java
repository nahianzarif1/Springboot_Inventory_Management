...
class ProductServiceTest {
    ...
    void createProduct_rejectsDuplicateSku() {
        productService.createProduct(new ProductCreateRequest("SKU1", "P1", null, BigDecimal.TEN, 1, null), "seller1");
        assertThrows(ConflictException.class,
                () -> productService.createProduct(new ProductCreateRequest("SKU1", "P2", null, BigDecimal.ONE, 1, null), "seller1"));
    }

    @Test
    void createProduct_rejectsNegativePrice() {
        assertThrows(ConflictException.class,
                () -> productService.createProduct(new ProductCreateRequest("SKU2", "P", null, new BigDecimal("-1"), 1, null), "seller1"));
    }

    @Test
    void updateProduct_rejectsOtherSeller() {
        var p = productService.createProduct(new ProductCreateRequest("SKU3", "P3", null, BigDecimal.ONE, 1, null), "seller1");
        ...
        assertThrows(ConflictException.class,
                () -> productService.updateProduct(p.id(), new ProductUpdateRequest("X", null, BigDecimal.ONE, 1, null), "seller2"));
    }
}
