...
@DataJpaTest
@Import({UserServiceImpl.class, PasswordConfig.class})
class UserServiceTest {
    ...
    void updateUserRole_changesRole() {
        var user = userRepository.save(User.builder().username("u1").email("u1@test.com").passwordHash("x").roles(Set.of(Role.BUYER)).enabled(true).build());
